...
class _$AccountResponseImpl implements _AccountResponse {
  const _$AccountResponseImpl({this.id, this.name, this.lastName, this.email});
  ...
  @override
  String toString() {
    return 'AccountResponse(id: $id, name: $name, lastName: $lastName, email: $email)';
  }
...
abstract class _AccountResponse implements AccountResponse {
  const factory _AccountResponse(
      ...
      final String? name,
      final String? lastName,
      final String? email}) = _$AccountResponseImpl;
